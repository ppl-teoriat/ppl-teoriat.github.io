...
Tämä kysymyspankki on tehty rakkaudesta lajiin vapaaehtoisvoimin.
Vastaukset ovat tarkistettu lennonopettajan kanssa.
Jos kuitenkin huomaat jonkin virheen, pyytäisin ilmoittamaan siitä [GitHub:in kautta](https://github.com/ppl-teoriat/ppl-teoriat.github.io/issues)
tai sähköpostitse **pplteoriat /ät/ gmail.com**.
Kysymyspankista voi myös puuttua Traficomin uusimpia kysymyksiä.
Olisin erittäin kiitollinen, jos pystyt lähettämään näitä oikein vastauksineen samalla tavalla, joko GitHub:iin tai sähköpostitse :)

## Kuulostaa hyvältä!

Jatka Ankin ja kysymyspankin lataukseen sekä konfigurointiin:

[**Asennusohjeet**](/asenna)
