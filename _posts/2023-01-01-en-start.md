...
This webpage will guide you to install the Anki application and import the Finnish LAPL/PPL(A) questionbank into it.
...
Anki is a free application, that uses the [spaced repetition](https://en.wikipedia.org/wiki/Spaced_repetition) technique to get you to remember arbitrary information and to move knowledge to your long-term memory.
The application works as follows:
- You will get ~50 new questions per theory exam per day
  - If this feels like much (and it _is_ too much for many!), you can adjust the amount in the application settings
...
Many students who use Anki pass their exams on the first try.  
...
This questionbank was made by voluntary work to spread good in the Finnish general aviation community.
The answers have been checked by a CFI.
Regardless, if you see a mistake in the questions, please report it through [GitHub](https://github.com/ppl-teoriat/ppl-teoriat.github.io/issues) or send an email to **pplteoriat /attttt/ gmail.com**.
...
I would be very grateful if you could submit newer questions along with their correct answers either to GitHub or via email :)
